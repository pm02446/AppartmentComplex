		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<div class="box">
							<span class="image featured"><section id="h2"><img src="images/pic01.jpg" alt="" /><center><p><h2><?php echo "Welcome, ",$first ." " .$last ."!"; ?></h2></p></center></section></span>
						<center><a href="newUser.php" class="button">New Renter</a> <a href="logout.php" class="button">Post Payments</a> <a href="logout.php" class="button">Add Pets</a> <a href="logout.php" class="button">Add Documents</a> <a href="workAdmin.php" class="button">Work Orders</a></center><br>
					</div>
						<div class="box">
